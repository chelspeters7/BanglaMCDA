...
for (kjl in 0:n+1){
  ...
  source("electre3.r")
  rank.local[,kjl] <- local_electre3_value
  rank.ngo[,kjl] <- ngo_electre3_value
  rank.aca[,kjl] <- aca_electre3_value
}
...
# ===========================================================================================================
# Plotting of Results
png(file = "MonteCarloRankingelectre3.png", width = 1152, height = 640)
...
png(file = "ELECTRE3_Local_Weights.png", width = 1152, height = 640)
beh.x <- beh.local.wei
nbeh.x <- nbeh.local.wei
source("DistributionPlot.r")
mtext("ELECTRE III, Local Perception, Top Two Ranks, Weights", outer = TRUE, cex = 1.5)
dev.off()
# ===========================================================================================================
...
png(file = "ELECTRE3_Local_Scoring.png", width = 1152, height = 640)
beh.x <- beh.local.sco
nbeh.x <-nbeh.local.sco
source("DistributionPlotScores.r")
mtext("ELECTRE III, Local Perception, Top Two Ranks, Scoring", outer = TRUE, cex = 1.5)
dev.off()
# ===========================================================================================================
...
png(file = "ELECTRE3_NGO_Weights.png", width = 1152, height = 640)
beh.x <- beh.ngo.wei
nbeh.x <- nbeh.ngo.wei
source("DistributionPlot.r")
mtext("ELECTRE III, NGO Perception, Top Two Ranks, Weights", outer = TRUE, cex = 1.5)
dev.off()
# ===========================================================================================================
...
png(file = "ELECTRE3_NGO_Scoring.png", width = 1152, height = 640)
beh.x <- beh.ngo.sco
nbeh.x <-nbeh.ngo.sco
source("DistributionPlotScores.r")
mtext("ELECTRE III, NGO Perception, Top Two Ranks, Scoring", outer = TRUE, cex = 1.5)
dev.off()
# ===========================================================================================================
...
png(file = "ELECTRE3_ACA_Weights.png", width = 1152, height = 640)
beh.x <- beh.aca.wei
nbeh.x <- nbeh.aca.wei
source("DistributionPlot.r")
mtext("ELECTRE III, Academic Perception, Top Two Ranks, Weights", outer = TRUE, cex = 1.5)
dev.off()
# ===========================================================================================================
# Testing weighting distributions
...
# ===========================================================================================================
# Scoring distributions
png(file = "ELECTRE3_ACA_Scoring.png", width = 1152, height = 640)
beh.x <- beh.aca.sco
nbeh.x <-nbeh.aca.sco
source("DistributionPlotScores.r")
mtext("ELECTRE III, Academic Perception, Top Two Ranks, Scoring", outer = TRUE, cex = 1.5)
dev.off()
# ===========================================================================================================
# Testing scoring distributions
...
png(file = "SignificantParameterDistributionsELECTRE3.png", width = 1152, height = 640)
plot <- ggplot(data2, aes(x = Behavior, y = Value, color = Stakeholder)) + 
  facet_wrap(~Label, ncol = 4)+
  geom_boxplot()+
  labs(title ="Significant Parameter Distribution in ELECTRE III", x = "", y = "Score") +
  theme_classic() +
  theme_bw()+
...
png(file = "SignificantParameterDistributionsELECTRE3Weights.png", width = 1152, height = 640)
plot <- ggplot(dataw, aes(x = Behavior, y = Value, color = Stakeholder)) + 
  facet_wrap(~Criteria, ncol = 4)+
  geom_boxplot()+
  labs(title ="Significant Parameter Distribution in ELECTRE III", x = "", y = "Weight") +
  theme_classic() +
  theme_bw()+
  theme(axis.text =  element_text(color = "black", size = 16))+
  theme(text = element_text(size = 30, family = "Garamond", color = "black"))+
